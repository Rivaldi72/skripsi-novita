...
<div class="content-header row text-center" style="min-height: 73vh;">
    <div class="col-12">
        <div class="row">
            <div class="col-12">
                <h2 class="content-header-title mb-2 mt-0">MAHAD ABU UBAIDAH BIN AL-JARRAH MEDAN</h2>
                <h2 class="content-header-title mb-0 mt-2">“Menjadi Pusat Pendidikan Alquran, Bahasa Arab & Studi Islam Terbaik yang menyebarkan nilai-nilai Islam sebagai Agama yang Rahmatan lil ‘alamin"</h2>
                <h6 class="content-header-title mb-0 mt-2">H.Fajar Hasan Mursyid,Lc.,MA (Direktur Ma'had) & Ahmad Afandi,S.Kom.,M.M (Sekretaris Ma'had)</h6>
            </div>
        </div>
        <div class="row mt-2">
            <div class="col-4">
            ...
            <div class="col-4">
                <h2 class="content-header-title mb-0 mt-2">Visi</h2>
                <h6 class="content-header-title mb-0 mt-2">“Menjadi Pusat Pendidikan Alquran, Bahasa Arab & Studi Islam Terbaik yang menyebarkan nilai-nilai Islam sebagai Agama yang Rahmatan lil ‘alamin.”</h6>
            </div>
            <div class="col-4">
                <h2 class="content-header-title mb-0 mt-2">Misi</h2>
                <h6 class="content-header-title mb-0 mt-2">Mengajarkan Bahasa Arab Fushah yakni Bahasa Alquran dengan metode yang efektif kepada para peserta.
                    Mengajarkan pokok ajaran Islam sesuai dengan Alquran dan Al-hadist.
                    Berkontribusi dalam melahirkan Guru-guru dan ulama yang menyebarkan nilai-nilai Islam sebagai agama yang Rahmatan lil ‘alamin.</h6>
            </div>
        </div>
    </div>
    </div>
