...
<body class="horizontal-layout horizontal-menu 2-columns  navbar-floating footer-static" data-open="hover" data-menu="horizontal-menu" data-col="2-columns">
                ...
                <div class="row">
                    ...
                    <div class="col-10 float-right">
                        <ul class="nav navbar-nav float-right" id="main-menu-navigation" data-menu="menu-navigation">
                            ...
                            <li class="nav-item ml-1 {{ (request()->is('login')) ? 'active' : '' }}" data-menu=""><a class="dropdown-item active rounded" id="btn-login" href="{{ route('login') }}"><i class=""></i>Login</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="app-content content mt-n5" style="min-height: 100vh;"">
